...
namespace TEP.Domain.Tests.Entities
{
    ...
    public class RecursiveStepTests
    {
        ...
        public RecursiveStepTests()
        {
            ...
            Interaction _doorInteraction = new Interaction(openDoorCategories, Act.Grab, openDoorDescription, openDoorExpected, openDoorLimit);
            ...
            Interaction _grabHugInteraction = new Interaction(grabHugCategories, Act.Grab, grabHugDescription, grabHugExpected, grabHugLimit);
